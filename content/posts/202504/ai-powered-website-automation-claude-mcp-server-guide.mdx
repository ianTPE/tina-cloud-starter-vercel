...
jsx{  "mcpServers": {    "vercel": {      "command": "npx",      "args": \[        "--package",        "@vercel/sdk",        "mcp",        "start",        "--bearer-token",        "\<YOUR\_BEARER\_TOKEN>"      ]    }  }}
...
jsx{  "mcpServers": {    "github": {      "command": "docker",      "args": \[        "run",        "-i",        "--rm",        "-e",        "GITHUB\_PERSONAL\_ACCESS\_TOKEN=\<YOUR\_TOKEN>",        "ghcr.io/github/github-mcp-server"      ]    }  }}
...
jsx{  "mcpServers": {    "mcp-cli-exec": {      "command": "npx",      "args": \["-y", "mcp-cli-exec"]    }  }}
