...
export const PrismCodeBlock: React.FC<CodeBlockProps> = ({ lang = 'javascript', value = '' }) => {
      ...
      >
        {({ className, style, tokens, getLineProps, getTokenProps }) => (
          <pre 
            ...
            style={{ ...style, fontFamily: 'ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, monospace' }}
          >
            {tokens.map((line, i) => (
